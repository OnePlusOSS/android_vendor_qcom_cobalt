...
#ifdef VENDOR_EDIT
#Angela 20180117 add lib for soft sim
#SOFTSIMLIB
SOFTSIMLIB := libpl_droidsonroids_gif
SOFTSIMLIB += libpl_droidsonroids_gif_surface
SOFTSIMLIB += libSecureKeyBoxJava
#endif/*VENDOR_EDIT*/
...
GPS += vendor.qti.gnss@$(LOC_HIDL_VERSION)-service
...
HBTP += improveTouch
HBTP += qtc801s.bin
HBTP += hbtpcfg_sdm670_801s_qhd.dat
HBTP += hbtpcfg_sdm660_801s_qhd.dat
HBTP += hbtpcfg_sdm670_800h_qhd.dat
HBTP += hbtpcfg_sdm670_800s_fhd.dat
HBTP += hbtpcfg_sdm670_801s_2k.dat
...
ifneq ($(TARGET_BUILD_VARIANT),user)
HY11_HY22_diff += seccamsample
HY11_HY22_diff += SnapdragonSVA
HY11_HY22_diff += ConnectionManagerTestApp
HY11_HY22_diff += Qmmi
endif
...
#add by lifei in 20171226 use different acdb for Meet the European standard
MM_AUDIO += EU_Bluetooth_cal.acdb
MM_AUDIO += EU_General_cal.acdb
MM_AUDIO += EU_Global_cal.acdb
MM_AUDIO += EU_Handset_cal.acdb
MM_AUDIO += EU_Hdmi_cal.acdb
MM_AUDIO += EU_Headset_cal.acdb
MM_AUDIO += EU_Speaker_cal.acdb
MM_AUDIO += EU_workspaceFile.qwsp
#endif/*VENDOR_EDIT*/
...
MM_AUDIO += ftm_test_config_sdm670-tasha-snd-card
MM_AUDIO += ftm_test_config_sdm670-tavil-snd-card
...
MM_CAMERA += libchromatix_imx398_isp_zsl_snapshot
MM_CAMERA += libchromatix_imx398_3a_wechat_preview
MM_CAMERA += libchromatix_imx398_preview_1080p_cpp
...
MM_CAMERA += libchromatix_imx376k_3a_2592x1940_30fps_preview_wechat
...
MM_CAMERA += libchromatix_imx371_cpp_640x480_30fps_video
...
ifeq ($(TARGET_BOARD_AUTO),true)
MM_CAMERA += libais
MM_CAMERA += libais_client
MM_CAMERA += libais_config
MM_CAMERA += libais_ti960
MM_CAMERA += ais_server
MM_CAMERA += libais_ba
MM_CAMERA += qcarcam_test
MM_CAMERA += qcarcam_config_single.xml
endif
...
#ifdef VENDOR_EDIT
#yanweibo@media,2017/12/12,add for DRM L1
...
#ifdef VENDOR_EDIT
#yanweibo@meida,2017/12/12,Integrate DRM L1
#TZ APP FOR WV DASH
WVDASH := widevine.b00
WVDASH += widevine.b01
WVDASH += widevine.b02
...
QMMF_SDK_DEBUG += qmmf_video_recorder_timelapse

...
OEM_PRODUCT_LIST := cheeseburger
OEM_PRODUCT_LIST += dumpling
...
#ifdef VENDOR_EDIT
#lifei@OnePlus.MultiMediaService, 2017/02/07,add BT aptx encode lib for 16859 version
#ONEPLUSLIB
ONEPLUSLIB := libdirac_capiv2
ONEPLUSLIB += libdirac_capiv2.so
ONEPLUSLIB += capi_v2_aptX_Classic
ONEPLUSLIB += capi_v2_aptX_Classic.so
ONEPLUSLIB += capi_v2_aptX_HD
ONEPLUSLIB += capi_v2_aptX_HD.so
ONEPLUSLIB += libdirac17801-capiv2
ONEPLUSLIB += libdirac17801-capiv2.so
#endif/*VENDOR_EDIT*/
...
#QTI_FEEDBACK
ifeq ($(call is-board-platform-in-list,msm8952 msm8976 sdm660),true)
QTI_FEEDBACK := QtiFeedback
QTI_FEEDBACK += libpoll_cpu_freq
QTI_FEEDBACK += q_interface_permissions.xml
endif
...
MM_AUDIO += ftm_test_config_sdm660-tasha-snd-card
MM_AUDIO += ftm_test_config_sdm660-tasha-skus-snd-card
MM_AUDIO += ftm_test_config_sdm660-tavil-snd-card
MM_AUDIO += ftm_test_config_sdm660-snd-card-skush
...
MM_CAMERA += libactuator_lc898217xc_imx398
MM_CAMERA += libactuator_lc898217xc_imx350
...
#imx398 chromatix 2017-01-09
MM_CAMERA += libchromatix_imx398_3a_1476x834_120fps_video
MM_CAMERA += libchromatix_imx398_3a_2328x1304_60fps_video
MM_CAMERA += libchromatix_imx398_3a_3264x2448_24fps_preview_bokeh
MM_CAMERA += libchromatix_imx398_3a_3264x2448_30fps_preview_bokeh
MM_CAMERA += libchromatix_imx398_3a_4608x3456_30fps_preview_bokeh
MM_CAMERA += libchromatix_imx398_3a_4656x2608_30fps_preview
MM_CAMERA += libchromatix_imx398_3a_4656x2608_30fps_video
MM_CAMERA += libchromatix_imx398_3a_4656x2608_30fps_video_4k
MM_CAMERA += libchromatix_imx398_3a_4656x3496_30fps_preview
MM_CAMERA += libchromatix_imx398_3a_4656x3496_30fps_video
MM_CAMERA += libchromatix_imx398_3a_hq
MM_CAMERA += libchromatix_imx398_3a_panorama
MM_CAMERA += libchromatix_imx398_3a_manual
MM_CAMERA += libchromatix_imx398_cpp_1476x834_120fps_video
MM_CAMERA += libchromatix_imx398_cpp_2328x1304_60fps_video
MM_CAMERA += libchromatix_imx398_cpp_3264x2448_30fps_preview_bokeh
MM_CAMERA += libchromatix_imx398_cpp_3264x2448_30fps_snapshot_bokeh
MM_CAMERA += libchromatix_imx398_cpp_4608x3456_snapshot_bokeh
MM_CAMERA += libchromatix_imx398_cpp_4656x2608_30fps_preview
MM_CAMERA += libchromatix_imx398_cpp_4656x2608_30fps_video
MM_CAMERA += libchromatix_imx398_cpp_4656x2608_30fps_video_4k
MM_CAMERA += libchromatix_imx398_cpp_4656x3496_30fps_preview
MM_CAMERA += libchromatix_imx398_cpp_4656x3496_30fps_snapshot
MM_CAMERA += libchromatix_imx398_cpp_4656x3496_30fps_video
MM_CAMERA += libchromatix_imx398_cpp_snapshot_hdr
MM_CAMERA += libchromatix_imx398_cpp_snapshot_flash
MM_CAMERA += libchromatix_imx398_cpp_snapshot_manual
MM_CAMERA += libchromatix_imx398_cpp_snapshot_nomultiframe
MM_CAMERA += libchromatix_imx398_cpp_snapshot_zoom
MM_CAMERA += libchromatix_imx398_cpp_snapshot_motion
MM_CAMERA += libchromatix_imx398_isp_1476x834_120fps_video
MM_CAMERA += libchromatix_imx398_isp_2328x1304_60fps_video
MM_CAMERA += libchromatix_imx398_isp_3264x2448_30fps_snapshot_bokeh
MM_CAMERA += libchromatix_imx398_isp_4656x2608_30fps_video
MM_CAMERA += libchromatix_imx398_isp_4656x3496_30fps_preview
MM_CAMERA += libchromatix_imx398_isp_4656x3496_30fps_snapshot
MM_CAMERA += libchromatix_imx398_isp_4656x3496_30fps_video
MM_CAMERA += libchromatix_imx398_isp_manual
MM_CAMERA += libchromatix_imx398_isp_panorama
MM_CAMERA += libchromatix_imx398_postproc
MM_CAMERA += libchromatix_imx398_common

#imx350 chromatix 2017-01-19
MM_CAMERA += libchromatix_imx350_common
MM_CAMERA += libchromatix_imx350_postproc
MM_CAMERA += libchromatix_imx350_3a_1536x866_30fps_video
MM_CAMERA += libchromatix_imx350_3a_2304x1300_30fps_preview
MM_CAMERA += libchromatix_imx350_3a_2304x1300_30fps_video
MM_CAMERA += libchromatix_imx350_3a_2592x1940_24fps_preview_bokeh
MM_CAMERA += libchromatix_imx350_3a_4160x3120_30fps_preview_bokeh
MM_CAMERA += libchromatix_imx350_3a_4608x3456_27fps_preview
MM_CAMERA += libchromatix_imx350_3a_5184x3880_30fps_preview
MM_CAMERA += libchromatix_imx350_cpp_1536x866_30fps_video
MM_CAMERA += libchromatix_imx350_cpp_2304x1300_30fps_video
MM_CAMERA += libchromatix_imx350_cpp_4160x3120_30fps_preview_bokeh
MM_CAMERA += libchromatix_imx350_cpp_4160x3120_30fps_snapshot_bokeh
MM_CAMERA += libchromatix_imx350_cpp_4608x3456_27fps_preview
MM_CAMERA += libchromatix_imx350_cpp_4608x3456_27fps_snapshot
MM_CAMERA += libchromatix_imx350_cpp_5184x3880_30fps_preview
MM_CAMERA += libchromatix_imx350_cpp_5184x3880_30fps_snapshot
MM_CAMERA += libchromatix_imx350_isp_1536x866_30fps_video
MM_CAMERA += libchromatix_imx350_isp_2304x1300_30fps_video
MM_CAMERA += libchromatix_imx350_isp_4160x3120_30fps_snapshot_bokeh
MM_CAMERA += libchromatix_imx350_isp_4608x3456_27fps_snapshot
MM_CAMERA += libchromatix_imx350_isp_5184x3880_30fps_snapshot

#imx376k chromatix 2017-07-24
MM_CAMERA += libchromatix_imx376k_common
MM_CAMERA += libchromatix_imx376k_postproc
MM_CAMERA += libchromatix_imx376k_3a_1840x1380_30fps_preview_bokeh
MM_CAMERA += libchromatix_imx376k_3a_2592x1458_60fps_video
MM_CAMERA += libchromatix_imx376k_3a_2592x1458_120fps_video
MM_CAMERA += libchromatix_imx376k_3a_2592x1940_30fps_preview_bokeh
MM_CAMERA += libchromatix_imx376k_3a_2592x1940_30fps_preview
MM_CAMERA += libchromatix_imx376k_cpp_2592x1458_60fps_video
MM_CAMERA += libchromatix_imx376k_cpp_2592x1458_120fps_video
MM_CAMERA += libchromatix_imx376k_cpp_2592x1940_24fps_preview_bokeh
MM_CAMERA += libchromatix_imx376k_cpp_2592x1940_24fps_snapshot_bokeh
MM_CAMERA += libchromatix_imx376k_cpp_2592x1940_30fps_preview
MM_CAMERA += libchromatix_imx376k_cpp_2592x1940_30fps_snapshot
MM_CAMERA += libchromatix_imx376k_isp_2592x1458_60fps_video
MM_CAMERA += libchromatix_imx376k_isp_2592x1458_120fps_video
MM_CAMERA += libchromatix_imx376k_isp_2592x1940_24fps_snapshot_bokeh
MM_CAMERA += libchromatix_imx376k_isp_2592x1940_30fps_snapshot
...
MM_CAMERA += libchromatix_imx179_1080p_preview_3a
MM_CAMERA += libchromatix_imx179_1080p_video_3a
MM_CAMERA += libchromatix_imx179_4k_preview_3a
MM_CAMERA += libchromatix_imx179_4k_video_3a
MM_CAMERA += libchromatix_imx179_common
MM_CAMERA += libchromatix_imx179_cpp_hfr_120
MM_CAMERA += libchromatix_imx179_cpp_hfr_240
MM_CAMERA += libchromatix_imx179_cpp_hfr_60
MM_CAMERA += libchromatix_imx179_cpp_liveshot
MM_CAMERA += libchromatix_imx179_cpp_preview
MM_CAMERA += libchromatix_imx179_cpp_snapshot
MM_CAMERA += libchromatix_imx179_cpp_snapshot_downscale
MM_CAMERA += libchromatix_imx179_cpp_snapshot_hdr
MM_CAMERA += libchromatix_imx179_cpp_snapshot_upscale
MM_CAMERA += libchromatix_imx179_cpp_video
MM_CAMERA += libchromatix_imx179_cpp_video_4k
MM_CAMERA += libchromatix_imx179_cpp_video_hdr
MM_CAMERA += libchromatix_imx179_default_video
MM_CAMERA += libchromatix_imx179_default_preview_3a
MM_CAMERA += libchromatix_imx179_default_video_3a
MM_CAMERA += libchromatix_imx179_fullsize_preview_3a
MM_CAMERA += libchromatix_imx179_fullsize_video_3a
MM_CAMERA += libchromatix_imx179_hdr_snapshot_3a
MM_CAMERA += libchromatix_imx179_hdr_video_3a
MM_CAMERA += libchromatix_imx179_hfr_120
MM_CAMERA += libchromatix_imx179_hfr_120_3a
MM_CAMERA += libchromatix_imx179_hfr_240
MM_CAMERA += libchromatix_imx179_hfr_240_3a
MM_CAMERA += libchromatix_imx179_hfr_60
MM_CAMERA += libchromatix_imx179_hfr_60_3a
MM_CAMERA += libchromatix_imx179_postproc
MM_CAMERA += libchromatix_imx179_preview
MM_CAMERA += libchromatix_imx179_snapshot
MM_CAMERA += libchromatix_imx179_snapshot_hdr
MM_CAMERA += libchromatix_imx179_video_4k
MM_CAMERA += libchromatix_imx179_video_hdr
#imx398 chromatix 2017-01-09
MM_CAMERA += libchromatix_imx371_common
MM_CAMERA += libchromatix_imx371_isp_2304x1728_30fps_snapshot
MM_CAMERA += libchromatix_imx371_isp_2304x1728_30fps_video
MM_CAMERA += libchromatix_imx371_isp_4656x3456_30fps_snapshot
MM_CAMERA += libchromatix_imx371_isp_640x480_120fps_video
MM_CAMERA += libchromatix_imx371_3a_2304x1728_30fps_preview
MM_CAMERA += libchromatix_imx371_3a_2304x1728_30fps_video
MM_CAMERA += libchromatix_imx371_3a_4656x3456_30fps_preview
MM_CAMERA += libchromatix_imx371_3a_2304x1728_30fps_hdr
MM_CAMERA += libchromatix_imx371_3a_2304x1728_30fps_auto_hdr
MM_CAMERA += libchromatix_imx371_3a_640x480_120fps_video
MM_CAMERA += libchromatix_imx371_3a_2304x1728_30fps_face_register
MM_CAMERA += libchromatix_imx371_cpp_2304x1728_30fps_preview
MM_CAMERA += libchromatix_imx371_cpp_2304x1728_30fps_snapshot
MM_CAMERA += libchromatix_imx371_cpp_2304x1728_30fps_video
MM_CAMERA += libchromatix_imx371_cpp_4656x3456_30fps_snapshot
MM_CAMERA += libchromatix_imx371_cpp_2304x1728_30fps_hdr
MM_CAMERA += libchromatix_imx371_cpp_2304x1728_30fps_flash
MM_CAMERA += libchromatix_imx371_cpp_2304x1728_30fps_liveshot
MM_CAMERA += libchromatix_imx371_cpp_640x480_120fps_video
MM_CAMERA += libchromatix_imx371_postproc
...
MM_CAMERA += libmmcamera_sac_lib
MM_CAMERA += libmmcamera_sat_dummy_lib
...
MM_CAMERA += libmmcamera_imx371
#ifdef VENDOR_EDIT
MM_CAMERA += libmmcamera_sony_imx371_eeprom
MM_CAMERA += libSonyIMX371RmscLibrary
MM_CAMERA += libmmcamera_s5k3p8sp
MM_CAMERA += s5k3p8sp_chromatix.xml
MM_CAMERA += libmmcamera_s5k3p8sp_m24c64s_eeprom
MM_CAMERA += libcvface_api
MM_CAMERA += libmmcamera_imx376k
MM_CAMERA += imx376k_chromatix.xml
MM_CAMERA += libactuator_lc898217xc_imx376k
MM_CAMERA += libmmcamera_imx376k_gt24c64_eeprom
#endif
...
MM_CAMERA += libmmcamera_sat_dummy_lib
MM_CAMERA += libSonyIMX350PdafLibrary
...
MM_CAMERA += libmmcamera2_stats_lib
...
MM_CAMERA += libmmcamera_imglib_faceproc_adspstub2
...
MM_CAMERA += libmmcamera_sony_imx398_eeprom
MM_CAMERA += libmmcamera_sony_imx378_eeprom
MM_CAMERA += libmmcamera_imx398_gt24c64_eeprom
MM_CAMERA += libmmcamera_imx350_gt24c64ass_eeprom
...
MM_CAMERA += imx398_chromatix.xml
MM_CAMERA += imx350_chromatix.xml
...
MM_CAMERA += imx371_chromatix.xml
...
ifdef VENDOR_EDIT
OEM_SERVICES += com.qti.snapdragon.sdk.display
endif
...
#ifndef OOS_EDIT Remove
#ELEPHONY_APPS += ConferenceDialer
#endif /* OOS_EDIT */
...
TELEPHONY_APPS += EmbmsServiceTests
...
SNAPDRAGON_SDK_DISPLAY += qdcm_calib_data_samsung_s6e3fa6_1080p_cmd_mode_dsi_panel.xml
SNAPDRAGON_SDK_DISPLAY += qdcm_calib_data_samsung_s6e3fc1_cmd_mode_dsi_panel.xml
SNAPDRAGON_SDK_DISPLAY += calib.cfg
#endif
...
GPS_DBG += my.tests.snapdragonsdktest
...
SENSORS_DBG += libsensor_low_lat_32
...
SENSORS_DBG += sns_low_lat_test_client
SENSORS_DBG += sns_oem_test
SENSORS_DBG += sns_regedit_ssi
SENSORS_DBG += sns_smr_loopback_test
SENSORS_DBG += sns_sensor_test
SENSORS_DBG += sns_daf_test
